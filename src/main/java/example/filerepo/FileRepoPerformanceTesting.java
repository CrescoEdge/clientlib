...
public class FileRepoPerformanceTesting {
    ...
    public String deployFileRepo(String pipelineName, String repo_name_1, String repo_path_1) throws InterruptedException {
        ...
        if(launchRepo) {
            ...
            String uri = "https://github.com/CrescoEdge/filerepo/releases/download/1.3-SNAPSHOT/filerepo-1.3-SNAPSHOT.jar";
            ...
            pluginSavePath = "/Users/cody/IdeaProjects/filerepo/target/filerepo-1.3-SNAPSHOT.jar";
